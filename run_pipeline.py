...
class Pipeline:
    ...
    def run(self, data_path, test=False, save_model=False):
        ...
        if not test:
            ...
            y_pred = (y_pred_proba > 0.5).astype(int)  # Assuming 0.5 as default threshold
            ...
            with open('predictions.json', 'w') as file:
                json.dump({'predict_probas': predictions.tolist(), 'threshold': 0.5},
                          file)  # Modify threshold (0.099)??
